...
//2013-4-7-begin
#define claire_print   4
#define claire_write    5   
#define claire_read     6
#define OSF_SYS_getsim_cycle 7
#define flush_EM 8
#define claire_write_EM_directly 9
#define claire_read_EM_directly 10
//2013-4-7-end
