...
typedef struct context_t 
{
    ...
    /* program free segment by yangshuo 2013-3-20 */
   md_addr_t ld_free_base;

  /* program free segment by yangshuo 2013-3 */
  unsigned int ld_free_size;
	...
	/*Added by wxh, to support delay slot*/
	int delay_slot_mark;
    ...
    int waitFor;
  //----------------------------DH--2013-4-7-begin
  //long unsigned int timer_counter;
  //	long unsigned int timer_set;
  //	int timer_interrupt;
  //	int timer_enable;
  	int dh_flag;
	//int src_counter;
