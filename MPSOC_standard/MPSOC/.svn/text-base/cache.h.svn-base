...
//-----------------DH--2013-4-7-begin
#define CLAIRE_READ                 50
#define CLAIRE_WRITE                51
//-----------------2013-4-7-end
...
struct DIRECTORY_EVENT
{
	...
	byte_t **udata;                     	// for return of user data ptr
	enum mem_cmd cmd;			// access type, Read or Write 
        enum MC_cmd mc_cmd; //add for MC----yangshuo--2013-5-15
	struct RUU_station *rs;       
#ifdef SMD_USE_WRITE_BUF
...
extern int flitSize;
/*================MPSoC===2013-5-16====yangshuo*/
extern long long int freezeCounter;
/*----------------external memory----2013-4-24--yangshuo----*/
//extern char * EMemory;
//extern int EMint_num;
//extern int EMchar_num;
extern int EMint[EM];
/*----------------external memory----2013-4-24--yangshuo---*/
extern int MPSOC_contexts;
/*================MPSoC===2013-5-16====yangshuo*/
