...
mess_event::mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b, long p)
{
	time_ = t;
	mess_ = mt;
	src_ = a;
...
//OPT_ message or TD message
mess_event::mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b, const flit_template & f):
	time_(t),
	mess_(mt),
	src_(a),
	des_(b),
