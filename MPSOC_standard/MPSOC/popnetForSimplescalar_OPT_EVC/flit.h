...
class flit_template {
	...
	public:
		...
		int pathsetup() {return pathsetup_;}		
		int pathsetup() const {return pathsetup_;}		

		flit_template();
		flit_template(long a, flit_type b, add_type & c, add_type & d,
					time_type e, const Data_type & f, int p);
		flit_template(long a, long size, flit_type b, add_type & c, add_type & d,
					time_type e, const Data_type & f, int p);
